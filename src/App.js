...
class App extends Component {
  ...
  componentDidMount() {
    this.timerId = setInterval(this.onStartTimer, 1000)
  }
  ...
  render() {
    const {imageToMatch, activeTabId, score, time, isGameOver} = this.state
        ...
        <div className="match-game-bg-container">
          {isGameOver ? (
            ...
            <div className="match-game-responsive-container">
              <img src={imageToMatch} alt="match" className="match-lg-image" />
